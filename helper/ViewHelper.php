...
class ViewHelper {
    ...
    public function permisos($permiso = null)
    {
        ...
        if (isset($_SESSION['usuario']) and ($permiso == null or $_SESSION[$permiso] == 1)) {
            ...
            $this->redireccionConMensaje("admin", "yellow", "Non tes permiso para realizar esta operación");
        }
    }
    ...
    public function getSlug($str)
    {
        ...
        $sen_til = str_replace($a, $b, $str);

        //genero slug
        return mb_strtolower(preg_replace(array('/[^a-zA-Z0-9 -]/', '/[ -]+/', '/^-|-$/'), array('', '-', ''), $sen_til), 'UTF-8');
    }
}