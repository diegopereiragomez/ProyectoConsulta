...
$archivo = __DIR__ . "/../public/img/" .$noticia->imagen;
        $texto_imagen = "";
        if (is_file($archivo)){
            unlink($archivo);
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $extracto = filter_input(INPUT_POST, "extracto", FILTER_UNSAFE_RAW);
            ...
            $imagen_subida = ($_FILES['imagen']['name']) ? __DIR__."/../public/img/".$_FILES['imagen']['name'] : "";
            ...
            if ($id == "nuevo"){
                ...
                $consulta = $this->db->exec("INSERT INTO noticias 
                    ...
                    ('$titulo','$extracto','$autor','$fecha','$texto','$slug','$imagen')");
