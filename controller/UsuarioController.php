...
class UsuarioController
{
    ...
    public function entrar(){
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            $campo_usuario = filter_input(INPUT_POST, "usuario", FILTER_UNSAFE_RAW);
            $campo_clave = filter_input(INPUT_POST, "clave", FILTER_UNSAFE_RAW);
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $usuarios = (filter_input(INPUT_POST, 'usuarios', FILTER_UNSAFE_RAW) == 'on') ? 1 : 0;
            $noticias = (filter_input(INPUT_POST, 'noticias', FILTER_UNSAFE_RAW) == 'on') ? 1 : 0;
            $cambiar_clave = (filter_input(INPUT_POST, 'cambiar_clave', FILTER_UNSAFE_RAW) == 'on') ? 1 : 0;
